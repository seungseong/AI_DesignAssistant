  ...
  const CATEGORIES: CategoryOption[] = [
    { 
      ...
      children: [
        ...
        { value: '바지>전체', label: '팬츠' },
        { value: '상의>맨투맨/스웨트셔츠', label: '맨투맨/스웨트셔츠' },
        { value: '상의>후드 티셔츠', label: '후드/집업' },
        { value: '상의>셔츠/블라우스', label: '셔츠/블라우스' },
        { value: '상의>니트/스웨터', label: '니트/스웨터' },
        { value: '아우터>재킷', label: '재킷/점퍼' },
        { value: '아우터>가디건', label: '가디건' },
        { value: '아우터>슈트/블레이저 재킷', label: '슈트' },
        { value: '아우터>코트', label: '코트' },
        { value: '아우터>베스트', label: '베스트' },
        { value: '아우터>패딩', label: '패딩' },
        { value: '아우터>무스탕', label: '무스탕' },
        { value: '아우터>플리스/후리스', label: '플리스/후리스' },
        { value: '원피스>전체', label: '원피스' },
        { value: '기타>기타 및 기능성', label: '기타 및 기능성' }
      ]
    },
    { 
      label: '신발', 
